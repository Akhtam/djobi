 ...
 *
 * Shortfalls are shown, everything met is collapsed behind a count — the same shape as
 * `CoverageReport` and for the same reason. The useful content here is what the candidate has to
 * decide about (apply anyway? mention it in an answer? skip this one?), and a met/total ratio on
 * screen would turn a decision aid into a score.
 *
...
export function RequirementFitReport({ fit }: { fit: RequirementFit[] }) {
  ...
  return (
    <div className="coverage">
      <span className="eyebrow">What this posting asks for</span>
