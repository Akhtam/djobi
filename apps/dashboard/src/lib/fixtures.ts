...
export const fixtureApplications: Application[] = [
  {
    ...
    jobInfo: {
      ...
      requirements: [
        {
          text: 'Strong React and TypeScript',
          kind: 'required',
      ...
      requirements: [
        {
          ...
          postingSignal: '- 5+ years building production React applications',
        },
        {
        ...
        },
        {
          ...
          importance: 'high',
          importanceTier: 'stated',
          postingSignal: '- Experience improving frontend performance at scale',
        },
      ],
      keywords: [
        { term: 'React', category: 'framework', postingSpelling: null },
  ...
  },
  {
    ...
    jobInfo: {
      ...
      requirements: [
        ...
        {
          text: 'Static analysis background a plus',
          kind: 'preferred',
          yearsOfExperience: null,
          importance: null,
          importanceTier: null,
  ...
  },
  {
    ...
    jobInfo: {
      ...
      requirements: [
        {
          text: 'Shipped user-facing product',
          kind: 'unspecified',
          yearsOfExperience: null,
          importance: null,
          importanceTier: null,
  ...
  },
  {
    ...
    jobInfo: {
      ...
      requirements: [
        ...
        {
          text: 'Editor/canvas UI experience',
          kind: 'preferred',
          yearsOfExperience: null,
          importance: null,
          importanceTier: null,
  ...
  },
  {
    ...
    jobInfo: {
      ...
      requirements: [
        {
          text: 'An eye for interaction detail',
          kind: 'preferred',
          yearsOfExperience: null,
          importance: null,
          importanceTier: null,
